(function () {
  ...
  if (ua.match(/MicroMessenger/i) == 'micromessenger') {
    WX_CONFIG.wxShare('诚信，深圳更出彩', '', window.location.href, window.location.origin + '/smt/images/common/logo_small.png')
  }
  // 二维码
  ...
  document.querySelector("#btn").addEventListener("touchend",function(e){
